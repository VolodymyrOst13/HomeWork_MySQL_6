...
CREATE VIEW MyJoinsDB.View_famStatus_phone
...
SELECT * FROM MyJoinsDB.View_famStatus_phone;

CREATE VIEW MyJoinsDB.View_dateBirth_phone
AS SELECT phone as ТЕЛЕФОН, dateBirth as ДЕНЬ_НАРОЖДЕНИЯ, CONCAT(firstName, ' ', lastName) as ІМЯ FROM MyJoinsDB.Employee 
